...
{
public:
	explicit ServiceProxy(jobject javaObject);
...
private:
	...
	static v8::Handle<v8::Value> getServiceInstanceId(const v8::Arguments&);
	static v8::Handle<v8::Value> start(const v8::Arguments&);

	// Dynamic property accessors ----------------------------------------
	static v8::Handle<v8::Value> getter_serviceInstanceId(v8::Local<v8::String> property, const v8::AccessorInfo& info);
