...
class EntityProxy : public titanium::Proxy
{
public:
	explicit EntityProxy(jobject javaObject);
...
private:
	...
	static v8::Handle<v8::Value> getNotationName(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_notationName(v8::Local<v8::String> property, const v8::AccessorInfo& info);
