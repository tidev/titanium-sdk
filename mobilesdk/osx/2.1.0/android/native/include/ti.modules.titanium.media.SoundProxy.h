...
class SoundProxy : public titanium::Proxy
{
public:
	explicit SoundProxy(jobject javaObject);
...
private:
	...
	static v8::Handle<v8::Value> setLooping(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> isLooping(const v8::Arguments&);
	static v8::Handle<v8::Value> reset(const v8::Arguments&);
	...
	static v8::Handle<v8::Value> getter_looping(v8::Local<v8::String> property, const v8::AccessorInfo& info);
	static void setter_looping(v8::Local<v8::String> property, v8::Local<v8::Value> value, const v8::AccessorInfo& info);
