module.exports = new function() {
	...
	this.webviewEvalJSLockup = function() {
	...
	this.webviewBindingUnavailable = function() {
		var w = Ti.UI.createWindow();
		w.open();
	...
	this.webviewBindingAvailable = function() {
		var w = Ti.UI.createWindow();
		w.open();
		var wv = Ti.UI.createWebView({top: 0, width: 10, height: 10, url: 'test.html'});
		var listener = function(){
	...
	this.webviewBindingAvailableAfterSetHtml = function() {
		var w = Ti.UI.createWindow();
		w.open();
	...
	this.absoluteAndRelativeWinURLs = function() {
	...
	this.appendRowWithHeader = function() {
		var w = Ti.UI.createWindow();
		w.open();
	...
	this.appendRowAsArray = function() {
		var w = Ti.UI.createWindow();
	...
	this.windowOrientation = function() {
		var callback_error = function(e){
			Ti.API.debug(e);
			valueOf(true).shouldBeFalse();
		};
	...
	this.windowPixelFormat = function() {
	...
	this.convertPointToView = function() {
	...
	this.deleteCorrectRowIndex = function() {
		var callback_error = function(e){
			Ti.API.debug(e);
			valueOf(true).shouldBeFalse();
		};
	...
	this.childrenArrayEmpty = function() {
