module.exports = new function() {
	...
	this.testEncodeIntegers = function() {
	...
	this.testDecodeIntegers = function() {
		var buffer = Ti.createBuffer({ length: 8 });
		buffer[0] = 0x9a;
		buffer[1] = 0x78;
		buffer[2] = 0x56;
	...
	this.testEncodeFloatingPoint = function() {
		var buffer = Ti.createBuffer({ length: 8 });
	...
	this.testDecodeFloatingPoint = function() {
		var buffer = Ti.createBuffer({ length: 8 });
		// Should be ~1/3
		buffer[0] = 0x3f;
		buffer[1] = 0xd5;
	...
	this.testEncodeString = function() {
	...
	this.testDecodeString = function() {
		var TEST = "spät";
