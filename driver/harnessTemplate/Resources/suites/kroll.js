module.exports = new function() {
	...
	this.customProxyMethods = function() {
	...
	this.arrayMixedTypeAndConstructor = function() {
		valueOf(function() {
			Ti.a = ["abc", "def", 123];
		}).shouldNotThrowException();
