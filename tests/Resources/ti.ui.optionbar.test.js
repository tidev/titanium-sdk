 ...
 * Copyright (c) 2021-Present by Appcelerator, Inc. All Rights Reserved.
		...
		describe('.style', () => {
			it('OPTION_STYLE_BUTTON', finish => {
				const optionBar = Ti.UI.createOptionBar({
					...
					style: Ti.UI.OPTION_STYLE_BUTTON
				});
				function postlayout() {
					optionBar.removeEventListener('postlayout', postlayout);
					finish();
			...
			it('OPTION_STYLE_RADIO - horizontal', finish => {
				const optionBar = Ti.UI.createOptionBar({
					labels: [ 'A', 'B', 'C' ],
					layout: 'horizontal',
			...
			it('OPTION_STYLE_RADIO - vertical', finish => {
				const optionBar = Ti.UI.createOptionBar({
					labels: [ 'A', 'B', 'C' ],
					layout: 'vertical',
					style: Ti.UI.OPTION_STYLE_RADIO
