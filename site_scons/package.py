...
def zip_iphone_ipad(zf,basepath,platform,version):
	...
	for xib in ('iphone','ipad'):
		xib_name = 'MainWindow_%s.xib' % xib
		zf.write(os.path.join(top_dir,'iphone','Resources',xib_name),'%s/%s/Resources/%s'%(basepath,platform,xib_name))
