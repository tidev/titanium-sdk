{
	...
	"Without the 32-bit libraries, the Android Emulator will not work properly.": "Without the 32-bit libraries, the Android Emulator will not work properly.",
	...
	"Android SDK tools are located in a directory containing an ampersand (&)": "Android SDK tools are located in a directory containing an ampersand (&)",
	"There is a limitation on Windows where ampersands must be escaped with a ^, however the required Android batch files (android.bat and dx.bat) do not properly handle paths containing ampersands.": "There is a limitation on Windows where ampersands must be escaped with a ^, however the required Android batch files (android.bat and dx.bat) do not properly handle paths containing ampersands.",
	"Please move the Android SDK to a path that does not contain an ampersand and update the Titanium CLI android.sdkPath setting.": "Please move the Android SDK to a path that does not contain an ampersand and update the Titanium CLI android.sdkPath setting.",
	"You can suppress this error by running \"%s\".": "You can suppress this error by running \"%s\".",
	...
	"Emulator \"%s\" already running": "Emulator \"%s\" already running",
	...
	"The version may only contist of letters, numbers, dashes, underscores, pluses, and spaces.": "The version may only contist of letters, numbers, dashes, underscores, pluses, and spaces.",
