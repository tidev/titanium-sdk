 ...
 */
exports.analyzeFile = function analyzeFile(file, opts) {
	opts || (opts = {});
	opts.filename = file;
	return exports.analyze(fs.readFileSync(file).toString(), opts);
};
 ...
 * @throws {Error} An error if unable to parse the JavaScript
 */
exports.analyze = function analyze(contents, opts) {
	var ast,
		symbols = {},
		results = {
			original: contents,
