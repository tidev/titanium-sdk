...
exports.find = function (plugins, projectDir, logger, callback) {
	...
	exports.detect(projectDir, logger, function (installed) {
		plugins.forEach(function (plugin) {
			logger && logger.debug(__('Looking for Titanium plugin id: %s version: %s', plugin.id.cyan, (plugin.version || 'latest').cyan));
			if (plugin.id && installed[plugin.id]) {
				...
				logger && logger.warn(__('Could not find Titanium plugin id: %s version: %s', plugin.id.cyan, (plugin.version || 'latest').cyan));
