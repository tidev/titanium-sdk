	...
	switch (platform) {
		...
		case 'android':
			if (cli.argv['build-only']) {
				...
				switch (cli.argv.target) {
					case 'emulator':
						emulatorCmd.push(cmd[0], 'emulator', tiapp.name, cli.argv['android-sdk'], cli.argv['project-dir'] , tiapp.id, cli.argv['avd-id'], cli.argv['avd-skin'], cli.argv['avd-abi']);
						cmd.push('simulator', tiapp.name, cli.argv['android-sdk'], cli.argv['project-dir'] , tiapp.id, cli.argv['avd-id'], cli.argv['avd-skin'], cli.argv['avd-abi']);
						break;
