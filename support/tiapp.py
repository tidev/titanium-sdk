...
class TiAppXML(object):
	...
	def generate_infoplist(self,file,appid,family,project_dir,iphone_version):
		...
		iconorder = list([iconname+".png",iconname+"@2x.png",iconname+"-72.png",iconname+"-Small-50.png",iconname+"-Small.png",iconname+"-Small@2x.png",,iconname+"-144.png",iconname+"-Small-100.png",iconame+"-Small-58.png"])
