...
#		content = content.replace('Titanium-iPad','%s-iPad'%self.name)
		content = content.replace('Titanium-KitchenSink_iPad','%s-iPad'%self.name)
		content = content.replace('PRODUCT_NAME = %s-iPad'%self.namespace,'PRODUCT_NAME = "%s"'%self.name)
		content = content.replace('PRODUCT_NAME = "%s-iPad"'%self.namespace,'PRODUCT_NAME = "%s"'%self.name)
		content = content.replace('%s.plist'%self.name,'Info.plist')
		# content = self.remove_xcode_products(content)
		content = self.fix_xcode_targets(content)
		content = self.fix_xcode_resources(content)
		content = content.replace(self.namespace,self.name)
