...
module.exports = new function() {
	...
	this.tests = [
		...
		{name: "mediaPlayer", timeout: 10000},
	...
	//TIMOB-2802
	this.mediaControlStyle = function(testRun){
		...
		win.addEventListener('focus', function(){
			valueOf(testRun, function(){
				activeMovie.setMediaControlStyle(Titanium.Media.VIDEO_CONTROL_NONE);
			}).shouldNotThrowException();
			valueOf(testRun, function(){
				activeMovie.play();
			}).shouldNotThrowException();
