...
module.exports = new function() {
	...
	this.tests = [
	   ...
	   //var testval = false;  // "Ti.include" inside the function doesn't have access to global variable.
	                           // If the variable "testval" declared as a local variable test works.
