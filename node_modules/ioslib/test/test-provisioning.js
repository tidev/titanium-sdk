...
describe('provisioning', function () {
	...
	it('find best provisioning profiles with a cert, but without a device', function (done) {
		this.timeout(5000);
		this.slow(2000);
	...
	it('find best provisioning profiles without a cert, but with a device', function (done) {
		this.timeout(5000);
		this.slow(2000);
	...
	it('find best provisioning profiles with a cert and a device', function (done) {
		this.timeout(5000);
		this.slow(2000);
