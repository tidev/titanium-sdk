 ...
 */
exports.analyzeHtmlFile = function analyzeHtmlFile(file) {
	return exports.analyzeHtml(fs.readFileSync(file).toString());
};
 ...
 * @returns {Array} An array of app:// JavaScript files
 */
exports.analyzeHtml = function analyzeHtml(contents) {
	var files = [];
