					...
					xml.forEachElement(node, function (elem) {
						switch (elem.tagName) {
							...
							case 'extensions':
								...
								xml.forEachElement(elem, function (elem) {
									var opts = {
											target: xml.getValue(elem)
										},
										projectPath = elem.getAttribute('projectPath');
									projectPath && (opts.projectPath = projectPath);
