...
var data = [
	...
	{title:'Inline HTML w/ Trans Bg', hasChild:true, text:'<html><body><div style="color:black;">Hello from inline HTML. You should see white text and black background</div></body></html>', bgcolor:'transparent'},
