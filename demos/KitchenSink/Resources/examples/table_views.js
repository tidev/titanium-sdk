...
if (Titanium.Platform.name == 'iPhone OS')
{
	...
	data.push({title:'Append Row', hasChild:true, test:'../examples/table_view_row_append.js'});
	data.push({title:'Delete Row', hasChild:true, test:'../examples/table_view_row_delete.js'});
	data.push({title:'Insert Row', hasChild:true, test:'../examples/table_view_row_insert.js'});
	data.push({title:'Update Row', hasChild:true, test:'../examples/table_view_row_update.js'});
	data.push({title:'Set Row Data', hasChild:true, test:'../examples/table_view_set.js'});
	data.push({title:'Empty Table View', hasChild:true, test:'../examples/table_view_empty.js'});
	...
	data.push({title:'Table Auto Height', hasChild:true, test:'../examples/table_view_api_auto_height.js'});
