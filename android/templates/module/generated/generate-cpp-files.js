...
async function main() {
	...
	if (!bindingJsonPath || !fs.existsSync(bindingJsonPath)) {
		// Without this JSON the module's V8 bindings cannot be generated and the module would fail to load at runtime.
		throw new Error(`kroll-apt binding JSON not found at "${bindingJsonPath}". Cannot generate the module's C++ bindings.`);
	}
