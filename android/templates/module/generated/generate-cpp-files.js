...
async function main() {
	...
	if (!bindingJsonPath || !fs.existsSync(bindingJsonPath)) {
		// Without this JSON the module's V8 bindings cannot be generated and the module will fail to load at runtime.
		console.warn(`[WARN] kroll-apt binding JSON not found at "${bindingJsonPath}". Skipping C++ file generation.`);
		return;
	}
