...
public class HttpURLConnectionProxy extends KrollProxy
{
	@Kroll.constant public static final int UNSENT = TiHttpURLConnection.READY_STATE_UNSENT;
	@Kroll.constant public static final int OPENED = TiHttpURLConnection.READY_STATE_OPENED;
	@Kroll.constant public static final int HEADERS_RECEIVED = TiHttpURLConnection.READY_STATE_HEADERS_RECEIVED;
	@Kroll.constant public static final int LOADING = TiHttpURLConnection.READY_STATE_LOADING;
	@Kroll.constant public static final int DONE = TiHttpURLConnection.READY_STATE_DONE;
	...
	private TiHttpURLConnection client;


	public HttpURLConnectionProxy()
	{
		super();
		this.client = new TiHttpURLConnection(this);
	}

	public HttpURLConnectionProxy(TiContext tiContext)
	{
		this();
	}
	...
	// TODO: Need to replace this. This uses Apache.
	@Kroll.method
	...
	// This uses Apache. Needs to be replaced.
	@Kroll.method
	...
	{
		return "Ti.Network.HttpURLConnection";
	}
}
