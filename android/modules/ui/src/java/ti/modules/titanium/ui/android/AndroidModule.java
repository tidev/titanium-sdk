...
public class AndroidModule extends KrollModule
{
	...
	@Kroll.constant public static final int GRAVITY_END = GravityCompat.END;
	...
	@Kroll.constant public static final int GRAVITY_RELATIVE_HORIZONTAL_GRAVITY_MASK = GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
	@Kroll.constant public static final int GRAVITY_RELATIVE_LAYOUT_DIRECTION = GravityCompat.RELATIVE_LAYOUT_DIRECTION;
	@Kroll.constant public static final int GRAVITY_RIGHT = Gravity.RIGHT;
	@Kroll.constant public static final int GRAVITY_START = GravityCompat.START;
