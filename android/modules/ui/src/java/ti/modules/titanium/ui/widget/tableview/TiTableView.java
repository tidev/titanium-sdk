	...
	implements OnSearchChangeListener
{
	...
	public static final int SEPARATOR_STYLE_NONE = 0;
	public static final int SEPARATOR_STYLE_SINGLE_LINE = 1;
	...
	public TiTableView(TableViewProxy proxy)
	{
		...
		if (proxy.hasProperty(TiC.PROPERTY_SEPARATOR_STYLE)) {
			if(TiConvert.toInt(proxy.getProperty(TiC.PROPERTY_SEPARATOR_STYLE)) == SEPARATOR_STYLE_NONE) {
