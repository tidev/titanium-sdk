...
public class FBStreamDialog extends FBDialog
{
     ...
     * @param session
     */
    public FBStreamDialog(Activity context, FBSession session, FacebookModule tb, String attachment, String actionLinks, String targetId, String userMessagePrompt)
    {
