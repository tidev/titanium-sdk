...
public class FBFeedDialog extends FBDialog
{
     ...
     * @param session
     */
    public FBFeedDialog(Activity context, FBSession session, FacebookModule tb, Long templateId, String templateData, String bodyGeneral, String userMessagePrompt)
    {
