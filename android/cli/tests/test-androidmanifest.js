...
describe('AndroidManifest', function () {
	...
	describe('<uses-feature>', function () {
		...
		it("toString('xml')", function () {
			am.toString('xml').should.equal([
				...
				'	<uses-feature android:name="android.hardware.camera" android:required="true" android:glEsVersion="2"/>',
				'</manifest>'
			].join('\r\n'));
		});
	});
	...
	describe('AndroidManifest.xml Sample 1', function () {
		var am = new AndroidManifest(path.resolve('./resources/AndroidManifest-sample1.xml'));
	...
	describe('AndroidManifest.xml Sample 2', function () {
		var am = new AndroidManifest(path.resolve('./resources/AndroidManifest-sample2.xml'));
	...
	describe('AndroidManifest.xml Sample 3', function () {
		var am = new AndroidManifest(path.resolve('./resources/AndroidManifest-sample3.xml'));
	...
	describe('AndroidManifest.xml Sample 4', function () {
		var am = new AndroidManifest(path.resolve('./resources/AndroidManifest-sample4.xml'));
	...
	describe('AndroidManifest.xml Sample 5', function () {
		var am = new AndroidManifest(path.resolve('./resources/AndroidManifest-sample5.xml'));
