...
public class TiPoint
{
	...
	/*
	 * Create a new point with the 'x' and 'y' coordinates in pixel units.
	 */
	...
	/*
	 * Create a new point from an object with 'x' and 'y' properties. If any of these properties is missing, a default
	...
	/*
	 * Create a new point from an object with 'x' and 'y' properties. If any of these properties is missing, the default
	 * values will be used.
	 */
	...
	/*
	 * Create a new point with the 'x' and 'y' coordinates as string.
