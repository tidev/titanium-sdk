...
public class TiFileFactory
{
	...
	/**
	 * Identical to {@link #createTitaniumFile(String[], boolean)} except that the path is passed in as a single string
	 * instead of an array of path components.
	 * 
	 ...
	 * {"app://" , "appdata://" , "appdata-private://" , "file://", "content://" }, the file will be created in
	 * "appdata-private://" + path, where path is the given path.
	 * 
	...
	/**
	 * Retrieves/creates a data directory in which the application can place its own custom data files. Refer to
	 * {@link TiFileFactory#getDataDirectory(boolean)} for more details.
	 * 
	 * @param privateStorage determines the location of the data directory. If this is true, the location is
	 *            internal(app-data://), and external (SD) otherwise.
