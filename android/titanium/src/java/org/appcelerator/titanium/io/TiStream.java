...
{
	/**
	 * Implementing classes should use this method to read data into a buffer. Refer to <a
	 * href="https://wiki.appcelerator.org/display/guides/Stream+Spec">Stream Spec</a> for more details.
	 * 
	 * @param args arguments passed in. Must match the arguments listed in the <a
	 *            href="https://wiki.appcelerator.org/display/guides/Stream+Spec">Stream Spec</a>.
	...
	/**
	 * Implementing classes should use this method to write data from a buffer to this stream. Refer to <a
	 * href="https://wiki.appcelerator.org/display/guides/Stream+Spec">Stream Spec</a> for more details.
	 * 
	 * @param args arguments passed in. Must match the arguments listed in the <a
	 *            href="https://wiki.appcelerator.org/display/guides/Stream+Spec">Stream Spec</a>.
