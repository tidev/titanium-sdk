...
public class TiRHelper
{
	...
	/**
	 * Searches for an Android compiled resource given its path. These resources are traditionally accessed via a
	 * resource ID (either from the application's resource bundle, or Android's internal resource bundle)
	 * 
	 * @param path the resource's path.
	 * @param includeSystemResources indicates whether or not {@link #getResource(String, boolean)} will look in the
	 *            system's (Android) resource bundle, if the resource is not found in the application's resource bundle.
	 * @return the resource, if found.
	 * @throws ResourceNotFoundException the exception thrown when the resource is not found in either location listed
	 *             above.
	 * @module.api
	 */
	...
	/**
	 * Searches for an Android compiled resource given its path. Refer to {@link #getResource(String, boolean)} for more
	 * details.
	 * 
	 * @param path the resource's path
	 * @return the resource, if found.
	 * @throws ResourceNotFoundException the exception thrown when the resource is not found in either the application's
	 *             resource bundle, or Android's internal resource bundle.
	 * @module.api
	 */
	...
	/**
	 * Clears the cache. Should only be used in low memory situations as clearing the cache will adversely affect
	 * performance.
	 */
