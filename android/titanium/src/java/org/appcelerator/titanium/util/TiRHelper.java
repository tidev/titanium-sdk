...
public class TiRHelper {
	...
	public static int getImageRessource(String imageName) throws ResourceNotFoundException {
		...
		switch (density) {
			case DisplayMetrics.DENSITY_HIGH : resName = imageName + "_72"; break;
			case DisplayMetrics.DENSITY_MEDIUM : resName = imageName + "_48"; break;
			case DisplayMetrics.DENSITY_LOW :resName = imageName + "_36"; break;
		}
