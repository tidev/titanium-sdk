...
public:
	...
	static jintArray jsArrayToJavaIntArray(v8::Isolate* isolate, v8::Local<v8::Value> jsValue);
	...
	static jintArray jsArrayToJavaIntArray(v8::Isolate* isolate, JNIEnv *env, v8::Local<v8::Value> jsValue);
