...
public interface KrollExceptionHandler {
	...
	{
		public String title, message, sourceName, lineSource, stack, nativeStack;
		...
		{
			this(title, message, sourceName, line, lineSource, lineOffset, null, null);
		}
