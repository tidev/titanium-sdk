{
	...
	"Ampersands (&) are not allowed in the project name when targeting Android.": "Ampersands (&) are not allowed in the project name when targeting Android.",
	"In order to use an ampersand, you must define the app name using i18n strings.": "In order to use an ampersand, you must define the app name using i18n strings.",
