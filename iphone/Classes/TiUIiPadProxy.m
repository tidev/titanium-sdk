...
-(id)createSplitWindow:(id)args
{
	if ([TiUtils isIPad])
	{
        DEPRECATED_REPLACED_REMOVED(@"UI.iPad.createSplitWindow", @"3.6.0", @"5.4.0", @"UI.iOS.createSplitWindow()")
...
-(id)createDocumentViewer:(id)args
{
	if ([TiUtils isIPad])
	{
        DEPRECATED_REPLACED_REMOVED(@"UI.iPad.createDocumentViewer", @"2.1.1", @"5.4.0", @"UI.iOS.createDocumentViewer()")
