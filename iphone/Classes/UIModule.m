...
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_PARAGRAPH_SPACING_BEFORE, ParagraphAttributeParagraphSpacingBefore);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_HEAD_INDENT, ParagraphAttributeHeadIndent);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_TAIL_INDENT, ParagraphAttributeTailIndent);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_FIRST_LINE_HEAD_INDENT, ParagraphAttributeFirstLineHeadIndent);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_MINIUM_LINE_HEIGHT, ParagraphAttributeMinimumLineHeight);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_MAXIMUM_LINE_HEIGHT, ParagraphAttributeMaximumLineHeight);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_LINE_HEIGHT_MULTIPLE, ParagraphAttributeLineHeightMultiple);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_LINE_BREAK_MODE, ParagraphAttributeLineBreakMode);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_ALIGNMENT, ParagraphAttributeAlignment);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_BASE_WRITING_DIRECTION, ParagraphAttributeBaseWritingDirection);
MAKE_SYSTEM_PROP(PARAGRAPH_ATTRIBUTE_TAB_INTERVAL, ParagraphAttributeTabInterval);
