...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_DEFAULT,UIKeyboardTypeDefault, @"UI.KEYBOARD_DEFAULT", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_DEFAULT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_URL,UIKeyboardTypeURL, @"UI.KEYBOARD_URL", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_URL");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_ASCII,UIKeyboardTypeASCIICapable, @"UI.KEYBOARD_ASCII", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_ASCII");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_NUMBERS_PUNCTUATION,UIKeyboardTypeNumbersAndPunctuation, @"Titanium.UI.KEYBOARD_NUMBERS_PUNCTUATION", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_NUMBERS_PUNCTUATION");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_NUMBER_PAD,UIKeyboardTypeNumberPad, @"UI.KEYBOARD_NUMBER_PAD", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_NUMBER_PAD");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_DECIMAL_PAD,UIKeyboardTypeDecimalPad, @"UI.KEYBOARD_DECIMAL_PAD", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_DECIMAL_PAD");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_PHONE_PAD,UIKeyboardTypePhonePad, @"UI.KEYBOARD_PHONE_PAD", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_PHONE_PAD");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_NAMEPHONE_PAD,UIKeyboardTypeNamePhonePad, @"Titanium.UI.KEYBOARD_NAMEPHONE_PAD", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_NAMEPHONE_PAD");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_EMAIL,UIKeyboardTypeEmailAddress, @"UI.KEYBOARD_EMAIL", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_EMAIL");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_WEBSEARCH,UIKeyboardTypeWebSearch, @"UI.KEYBOARD_WEBSEARCH", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_WEBSEARCH");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(KEYBOARD_TWITTER,UIKeyboardTypeTwitter, @"UI.KEYBOARD_TWITTER", @"5.2.0", @"Titanium.UI.KEYBOARD_TYPE_TWITTER");
