...
{
    DEPRECATED_REPLACED_REMOVED(@"Media.AUDIO_SESSION_MODE_AMBIENT", @"3.4.2", @"5.4.0",@"Media.AUDIO_SESSION_CATEGORY_AMBIENT");
    return [NSNumber numberWithUnsignedInt:kAudioSessionCategory_AmbientSound];
}
-(NSNumber*)AUDIO_SESSION_MODE_SOLO_AMBIENT
{
    DEPRECATED_REPLACED_REMOVED(@"Media.AUDIO_SESSION_MODE_SOLO_AMBIENT", @"3.4.2", @"5.4.0", @"Media.AUDIO_SESSION_CATEGORY_SOLO_AMBIENT");
    return [NSNumber numberWithUnsignedInt:kAudioSessionCategory_SoloAmbientSound];
}
-(NSNumber*)AUDIO_SESSION_MODE_PLAYBACK
{
    DEPRECATED_REPLACED_REMOVED(@"Media.AUDIO_SESSION_MODE_PLAYBACK", @"3.4.2", @"5.4.0",  @"Media.AUDIO_SESSION_CATEGORY_PLAYBACK");
    return [NSNumber numberWithUnsignedInt:kAudioSessionCategory_MediaPlayback];
}
-(NSNumber*)AUDIO_SESSION_MODE_RECORD
{
    DEPRECATED_REPLACED_REMOVED(@"Media.AUDIO_SESSION_MODE_RECORD", @"3.4.2", @"5.4.0",  @"Media.AUDIO_SESSION_CATEGORY_RECORD");
    return [NSNumber numberWithUnsignedInt:kAudioSessionCategory_RecordAudio];
}
-(NSNumber*)AUDIO_SESSION_MODE_PLAY_AND_RECORD
{
    DEPRECATED_REPLACED_REMOVED(@"Media.AUDIO_SESSION_MODE_PLAY_AND_RECORD", @"3.4.2", @"5.4.0",  @"Media.AUDIO_SESSION_CATEGORY_PLAY_AND_RECORD");
...
{
    DEPRECATED_REPLACED_REMOVED(@"Media.VIDEO_CONTROL_VOLUME_ONLY", @"1.8.0", @"5.4.0", @"Media.VIDEO_CONTROL_EMBEDDED");
