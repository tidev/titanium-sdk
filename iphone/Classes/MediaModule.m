...
MAKE_SYSTEM_PROP_DEPRECATED_REMOVED(VIDEO_CONTROL_VOLUME_ONLY,MPMovieControlModeVolumeOnly, @"Ti.Media.VIDEO_CONTROL_VOLUME_ONLY", @"1.8.0", @"1.9.0");
MAKE_SYSTEM_PROP_DEPRECATED_REMOVED(VIDEO_CONTROL_HIDDEN,MPMovieControlModeHidden,@"Ti.Media.VIDEO_CONTROL_HIDDEN" ,@"1.8.0", @"1.9.0");
