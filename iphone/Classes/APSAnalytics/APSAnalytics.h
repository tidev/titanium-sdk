...
/**
 * Returns the last Analytics event.
 ...
 */
- (void)setBuildType:(NSString *)buildType;

/**
 * Sets the SDK version.
 * @param aVersion The SDK version.
 */
-(void)setSDKVersion:(NSString *)aVersion;

/**
 * Enables a new APSAnalytics session for a given app-key and deploy-type.
 * @param appKey The app-key to be used.
 * @param deployType The deploy-type to collect events from.
 */
