                    ...
                    hires:(BOOL)hires
{
  ...
  if ((newRect.size.width == CGImageGetWidth(imageRef)) && (newRect.size.height == CGImageGetHeight(imageRef)) && CGAffineTransformIsIdentity(transform)) {
                               ...
                               image:(UIImage *)image
{
  ...
  NSInteger left = (TiDimensionIsAuto(leftCap) || TiDimensionIsUndefined(leftCap) || leftCap.value == 0) ? maxWidth / 2 : TiDimensionCalculateValue(leftCap, maxWidth);
  NSInteger top = (TiDimensionIsAuto(topCap) || TiDimensionIsUndefined(topCap) || topCap.value == 0) ? maxHeight / 2 : TiDimensionCalculateValue(topCap, maxHeight);
