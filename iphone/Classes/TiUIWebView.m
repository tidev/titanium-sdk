...
-(void)setHtml_:(NSString*)content
{
	...
	NSURL *relativeURL = [NSURL URLWithString:[NSString stringWithFormat:@"app://%@/%@",TI_APPLICATION_ID,[urlstr stringByReplacingOccurrencesOfString:[NSString stringWithFormat:@"%@/",basepath] withString:@""]]];
