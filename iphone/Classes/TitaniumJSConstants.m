...
"Ti={_TOKEN:'%@',"		//Note to self. Store top._TOKENS[token] = window in order to redirect to subviews.
	...
	"_TIDO:function(obj,fun,arg){"
		"var res=null;"
		"var argstr='[';var sep='';var len=arg.length;"
		"for(var i=0;i<len;i++){"
			"var val=arg[i];"
			...
			"sep=',';"
		"}"
		"argstr+=']';var xhr=new Ti._NET();"
		"argstr='foo=bar';"
		"Ti.API.debug(argstr + '=' + argstr.length);"
		"try{"
			"xhr.open('post','/_TIDO/'+Ti._TOKEN+'/'+obj+'/'+fun,false);"
//			"xhr.setRequestHeader('Arguments',argstr);"
			"xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');"
//			"xhr.setRequestHeader('Content-type','text/plain');"
//			"xhr.setRequestHeader('Content-Length',argstr.length);"
