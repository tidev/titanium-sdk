...
- (void)loadView
{
    ...
    disclosureLabel.text = NSLocalizedString(@"Error messages will only be displayed during development. When your app is packaged for final distribution, no error screen will appear. Test your code!", nil);
    ...
    titleLabel.text = NSLocalizedString(@"Application Error", nil);
