...
MAKE_SYSTEM_STR(WORKER_ERROR_INVALID_PATH, kTiWorkerErrorInvalidPath);
MAKE_SYSTEM_STR(WORKER_ERROR_INVALID_HOST, kTiWorkerErrorInvalidHost);
MAKE_SYSTEM_STR(WORKER_ERROR_INVALID_CONTEXT, kTiWorkerErrorInvalidContext);
MAKE_SYSTEM_STR(WORKER_ERROR_INVALID_TEMPORARY_DIRECTORY, kTiWorkerErrorInvalidTemporaryDirectory);
MAKE_SYSTEM_STR(WORKER_ERROR_CANNOT_SERIALIZE, kTiWorkerErrorCannotSerialize);
