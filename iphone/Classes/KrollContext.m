...
- (void)main
{
  ...
  JSStringRef node = JSStringCreateWithUTF8CString("Worker");
  TiWorkerJS *workerJS = [TiWorkerJS new];
  JSObjectSetProperty(context, globalRef, node, JSObjectMake(context, [workerJS constructWithContext:context], NULL), kJSPropertyAttributeNone, NULL);
