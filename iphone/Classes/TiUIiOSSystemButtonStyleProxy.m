...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BORDERED, UIBarButtonItemStylePlain, @"Ti.UI.iOS.SystemButtonStyle.BORDERED", @"10.0.0", @"Ti.UI.BUTTON_STYLE_TEXT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(PLAIN, UIBarButtonItemStylePlain, @"Ti.UI.iOS.SystemButtonStyle.PLAIN", @"10.0.0", @"Ti.UI.BUTTON_STYLE_TEXT");
