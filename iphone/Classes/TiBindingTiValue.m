...
static BOOL TiValueIsArray(JSContextRef js_context_ref, JSValueRef js_value_ref) {
...
static BOOL TiValueIsDate(JSContextRef js_context_ref, JSValueRef js_value_ref) {
