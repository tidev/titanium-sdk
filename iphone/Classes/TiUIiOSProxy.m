...
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_NORMAL, kCGBlendModeNormal, @"UI.iOS.BLEND_MODE_NORMAL", @"7.2.0", @"UI.BLEND_MODE_NORMAL");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_MULTIPLY, kCGBlendModeMultiply, @"UI.iOS.BLEND_MODE_MULTIPLY", @"7.2.0", @"UI.BLEND_MODE_MULTIPLY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_SCREEN, kCGBlendModeScreen, @"UI.iOS.BLEND_MODE_SCREEN", @"7.2.0", @"UI.BLEND_MODE_SCREEN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_OVERLAY, kCGBlendModeOverlay, @"UI.iOS.BLEND_MODE_OVERLAY", @"7.2.0", @"UI.BLEND_MODE_OVERLAY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_DARKEN, kCGBlendModeDarken, @"UI.iOS.BLEND_MODE_DARKEN", @"7.2.0", @"UI.BLEND_MODE_DARKEN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_LIGHTEN, kCGBlendModeLighten, @"UI.iOS.BLEND_MODE_LIGHTEN", @"7.2.0", @"UI.BLEND_MODE_LIGHTEN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_COLOR_DODGE, kCGBlendModeColorDodge, @"UI.iOS.BLEND_MODE_COLOR_DODGE", @"7.2.0", @"UI.BLEND_MODE_COLOR_DODGE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_COLOR_BURN, kCGBlendModeColorBurn, @"UI.iOS.BLEND_MODE_COLOR_BURN", @"7.2.0", @"UI.BLEND_MODE_COLOR_BURN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_SOFT_LIGHT, kCGBlendModeSoftLight, @"UI.iOS.BLEND_MODE_SOFT_LIGHT", @"7.2.0", @"UI.BLEND_MODE_SOFT_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_HARD_LIGHT, kCGBlendModeHardLight, @"UI.iOS.BLEND_MODE_HARD_LIGHT", @"7.2.0", @"UI.BLEND_MODE_HARD_LIGHT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_DIFFERENCE, kCGBlendModeDifference, @"UI.iOS.BLEND_MODE_DIFFERENCE", @"7.2.0", @"UI.BLEND_MODE_DIFFERENCE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_EXCLUSION, kCGBlendModeExclusion, @"UI.iOS.BLEND_MODE_EXCLUSION", @"7.2.0", @"UI.BLEND_MODE_EXCLUSION");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_HUE, kCGBlendModeHue, @"UI.iOS.BLEND_MODE_HUE", @"7.2.0", @"UI.BLEND_MODE_HUE");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_SATURATION, kCGBlendModeSaturation, @"UI.iOS.BLEND_MODE_SATURATION", @"7.2.0", @"UI.BLEND_MODE_SATURATION");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_COLOR, kCGBlendModeColor, @"UI.iOS.BLEND_MODE_COLOR", @"7.2.0", @"UI.BLEND_MODE_COLOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_LUMINOSITY, kCGBlendModeLuminosity, @"UI.iOS.BLEND_MODE_LUMINOSITY", @"7.2.0", @"UI.BLEND_MODE_LUMINOSITY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_CLEAR, kCGBlendModeClear, @"UI.iOS.BLEND_MODE_CLEAR", @"7.2.0", @"UI.BLEND_MODE_CLEAR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_COPY, kCGBlendModeCopy, @"UI.iOS.BLEND_MODE_COPY", @"7.2.0", @"UI.BLEND_MODE_COPY");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_SOURCE_IN, kCGBlendModeSourceIn, @"UI.iOS.BLEND_MODE_SOURCE_IN", @"7.2.0", @"UI.BLEND_MODE_SOURCE_IN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_SOURCE_OUT, kCGBlendModeSourceOut, @"UI.iOS.BLEND_MODE_SOURCE_OUT", @"7.2.0", @"UI.BLEND_MODE_SOURCE_OUT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_SOURCE_ATOP, kCGBlendModeSourceAtop, @"UI.iOS.BLEND_MODE_SOURCE_ATOP", @"7.2.0", @"UI.BLEND_MODE_SOURCE_ATOP");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_DESTINATION_OVER, kCGBlendModeDestinationOver, @"UI.iOS.BLEND_MODE_DESTINATION_OVER", @"7.2.0", @"UI.BLEND_MODE_DESTINATION_OVER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_DESTINATION_IN, kCGBlendModeDestinationIn, @"UI.iOS.BLEND_MODE_DESTINATION_IN", @"7.2.0", @"UI.BLEND_MODE_DESTINATION_IN");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_DESTINATION_OUT, kCGBlendModeDestinationOut, @"UI.iOS.BLEND_MODE_DESTINATION_OUT", @"7.2.0", @"UI.BLEND_MODE_DESTINATION_OUT");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_DESTINATION_ATOP, kCGBlendModeDestinationAtop, @"UI.iOS.BLEND_MODE_DESTINATION_ATOP", @"7.2.0", @"UI.BLEND_MODE_DESTINATION_ATOP");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_XOR, kCGBlendModeXOR, @"UI.iOS.BLEND_MODE_XOR", @"7.2.0", @"UI.BLEND_MODE_XOR");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_PLUS_DARKER, kCGBlendModePlusDarker, @"UI.iOS.BLEND_MODE_PLUS_DARKER", @"7.2.0", @"UI.BLEND_MODE_PLUS_DARKER");
MAKE_SYSTEM_PROP_DEPRECATED_REPLACED(BLEND_MODE_PLUS_LIGHTER, kCGBlendModePlusLighter, @"UI.iOS.BLEND_MODE_PLUS_LIGHTER", @"7.2.0", @"UI.BLEND_MODE_PLUS_LIGHTER");
