...
{
  DEPRECATED_REPLACED(@"UI.iOS.CLIP_MODE_DEFAULT", @"14.0.0", @"UI.CLIP_MODE_DEFAULT");
  return NUMINT(0);
}
- (NSNumber *)CLIP_MODE_ENABLED
{
  DEPRECATED_REPLACED(@"UI.iOS.CLIP_MODE_ENABLED", @"14.0.0", @"UI.CLIP_MODE_ENABLED");
  return NUMINT(1);
}
- (NSNumber *)CLIP_MODE_DISABLED
{
  DEPRECATED_REPLACED(@"UI.iOS.CLIP_MODE_DISABLED", @"14.0.0", @"UI.CLIP_MODE_DISABLED");
  return NUMINT(-1);
}
