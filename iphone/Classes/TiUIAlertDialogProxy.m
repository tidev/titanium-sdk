        ...
        if ([TiUtils isIOS8OrGreater]) {
            ...
            if ( (style == UIAlertViewStylePlainTextInput) || (style == UIAlertViewStyleSecureTextInput) ) {
                ...
                [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
                    ...
                    textField.keyboardAppearance = [TiUtils intValue:[self valueForKey:@"keyboardAppearance"] def:UIKeyboardAppearanceDefault];
                    textField.placeholder = [TiUtils stringValue:[self valueForKey:@"loginHintText"]] ?: NSLocalizedString(@"Login", nil);
                }];
                [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
                    ...
                    textField.keyboardAppearance = [TiUtils intValue:[self valueForKey:@"keyboardAppearance"] def:UIKeyboardAppearanceDefault];
                    textField.placeholder = [TiUtils stringValue:[self valueForKey:@"passwordHintText"]] ?: NSLocalizedString(@"Password", nil);;
