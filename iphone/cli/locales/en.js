{
	...
	"type": "type",
	"the name for the device or iOS simulator to install the application to": "the name for the device or iOS simulator to install the application to",
	"name": "name",
	...
	"If you know where this executable is, you can tell the Titanium CLI where it located by running 'titanium config osx.executables.openssl /path/to/openssl'.": "If you know where this executable is, you can tell the Titanium CLI where it located by running 'titanium config osx.executables.openssl /path/to/openssl'.",
	...
	"iTunes Device Sync": "iTunes Device Sync"
}