...
- (instancetype)init
{
  self = [super init];
  if (self) {
    _coreModules = [[NSSet setWithArray:@[ @"Accessibility", @"Accelerometer", @"App", @"API", @"Calendar", @"Codec", @"Contacts", @"Database", @"Filesystem", @"Geolocation", @"Gesture", @"Locale", @"Media", @"Network", @"Platform", @"Stream", @"Utils", @"UI",
      @"WatchSession",
      @"XML" ]] retain];
  }
  return self;
